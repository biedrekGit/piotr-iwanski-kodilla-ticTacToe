...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            GamePresentation.showGameBoard(game1.getSymbols());
            if (game1.gameEnds()) {
                break;
            }
            System.out.println("Circle turn. Please choose field:");
            int circleInput = GamePresentation.chooseField(game1.getSymbols());
            ...
            int crossInput = GamePresentation.chooseField(game1.getSymbols());
